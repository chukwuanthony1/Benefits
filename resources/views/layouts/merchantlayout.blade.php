            ...
            <div class="page-sidebar-wrapper">
                <div class="page-sidebar navbar-collapse collapse">
                    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 10px">
                        ...
                        <br/>
                        <li class="nav-item">
                            <a href="{{ route('merchants.dashboard') }}" class="nav-link ">
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                ...
                                <span class="title">Product Mgt</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('merchant.products') }}" class="nav-link ">
                                        <i class="fa fa-th-list"></i>
                                        <span class="title">Products</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('merchant.product.new') }}" class="nav-link ">
                                        <i class="fa fa-th-list"></i>
                        ...
                        <li class="nav-item  ">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="fa fa-list"></i>
                                <span class="title">Coupon Mgt</span>
                                <span class="arrow"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item">
                                    <a href="{{ route('merchant.coupons') }}" class="nav-link ">
                                        <i class="fa fa-th-list"></i>
                                        <span class="title">Coupons</span>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ route('merchant.coupon.new') }}" class="nav-link ">
                                        <i class="fa fa-th-list"></i>
                                        <span class="title">New Coupon</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
